...
const paths: Record<string, string> = {
  ...
  // Engrenagem de contorno único (8 dentes) + eixo. A anterior tinha 12 raios
  // desenhados com arcos de raio 1,6 e coordenadas encostando na borda do
  // viewBox: a 18px no `icon-btn` da topbar os arcos se cruzavam e o desenho
  // virava um borrão. Poucos dentes e bem espaçados é o que sobrevive ao
  // tamanho pequeno.
  settings:
    "M12.22 2h-.44a2 2 0 0 0-2 2v.18a2 2 0 0 1-1 1.73l-.43.25a2 2 0 0 1-2 0l-.15-.08a2 2 0 0 0-2.73.73l-.22.38a2 2 0 0 0 .73 2.73l.15.1a2 2 0 0 1 1 1.72v.51a2 2 0 0 1-1 1.74l-.15.09a2 2 0 0 0-.73 2.73l.22.38a2 2 0 0 0 2.73.73l.15-.08a2 2 0 0 1 2 0l.43.25a2 2 0 0 1 1 1.73V20a2 2 0 0 0 2 2h.44a2 2 0 0 0 2-2v-.18a2 2 0 0 1 1-1.73l.43-.25a2 2 0 0 1 2 0l.15.08a2 2 0 0 0 2.73-.73l.22-.39a2 2 0 0 0-.73-2.73l-.15-.08a2 2 0 0 1-1-1.74v-.5a2 2 0 0 1 1-1.74l.15-.09a2 2 0 0 0 .73-2.73l-.22-.38a2 2 0 0 0-2.73-.73l-.15.08a2 2 0 0 1-2 0l-.43-.25a2 2 0 0 1-1-1.73V4a2 2 0 0 0-2-2zM12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6",
  ...
  store: "M3 9l1-5h16l1 5M4 9v9a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V9M3 9h18M9 20v-6h6v6",
  warehouse: "M2 21V9l10-5 10 5v12M2 21h20M7 21v-7h10v7M7 14h10M7 17.5h10",
  tree: "M12 22V12M12 12C12 8 9 6 4 6c0 4 3 6 8 6M12 12c0-3 2-5 6-5 0 3-2 5-6 5",
  ...
  // Logotipos de marca (Instagram, WhatsApp) não moram aqui: são glifos
  // preenchidos e vivem em `BrandIcon.tsx`.
};
